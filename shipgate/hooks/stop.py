...
empty stderr. Same trust-boundary family as the shipfile-integrity gap (also known,
also accepted for now, also not yet fixed): the gate trusting a piece of external,
unverified data absolutely. That one is the shipfile; this one is the hook payload.
**Fixed at the root**
